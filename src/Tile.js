...
function Tile() {
    function handleSubmit(event) {
        ...
        const message = `Name: ${name}%0D%0AEmail: ${email}%0D%0A`;
        const mailtoLink = `mailto:claud@silverbackco.us?subject=Form Submission&body=${message}`;
...
<img
      src="https://static.vecteezy.com/system/resources/previews/000/296/674/original/cute-gorilla-on-white-background-vector.jpg"
      alt="Silverback Gorilla"
      className="gorilla-image-footer"
    />
 <p className='follow-us-text'>FOLLOW  US</p>
 <a href="https://www.instagram.com/silverbackcompanyinc/" target="_blank">
  <img
    src="https://www.pngkey.com/png/detail/107-1075251_corao-png.png"
    alt="Silverback Gorilla"
    className="gorilla-image-footer"
  />
</a>
