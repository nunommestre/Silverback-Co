...
function Cleaning() {
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    ...
    <Nav className="mx-auto">
    <Link to="/Silverback-Co">
    <div className="gorilla-image-cleaning-wrapper">
    <img
    ...
    />
      ...
      <h1 className="centered">Silverback Cleaning</h1>
...
<img
 ...
 <a href="https://www.instagram.com/silverbackco_cleaning/" target="_blank">
  <img
